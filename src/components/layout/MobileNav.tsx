          ...
          <>
            ...
            >
              ...
              <div className='border-t border-border/50 pt-4 mt-4'>
                <a
                  href='https://github.com/mainawycliffe/easycode'
                  target='_blank'
                  rel='noopener noreferrer'
                  onClick={close}
                  className='flex items-center gap-3 px-4 py-3 rounded-lg text-base font-medium text-text-muted hover:text-text hover:bg-white/5 transition-colors'
                >
